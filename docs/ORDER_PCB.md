...
ガーバーファイルを追加後に「ドリル ファイルが見つかりません。 Excellon 形式の NC ドリル ファイルが含まれていることを確認してください。」というメッセージが出ますが、無視して差し支えありません。リポジトリに登録したガーバーファイルにはドリルファイルが含まれており、Fusion PCB で基板が正常に製造されることを確認しております。
